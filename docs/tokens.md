...
> **Source**: `@moloco/moloco-cloud-react-ui` | **Version**: 2.0.0
...
Semantic color system. Structure: color.[property].[role].[emphasis].[state]
...
| `text.brand.default` | `theme.mcui.palette.content.contentAccent` | `#346bea` | brand | Links, clickable text, brand actions |
| `text.brand.hovered` | `theme.mcui.palette.content.contentAccentHover` | `#0260C9` | brand (hovered) | Brand text hover state |
| `text.brand.pressed` | `theme.mcui.palette.content.contentAccentPressed` | `#014599` | brand (pressed) | Brand text pressed state |
...
| `text.link.default` | `theme.mcui.palette.content.contentAccent` | `#346bea` | brand | Hyperlink text default state |
| `text.link.hovered` | `theme.mcui.palette.content.contentAccentHover` | `#0260C9` | brand (hovered) | Hyperlink text on hover |
| `text.link.pressed` | `theme.mcui.palette.content.contentAccentPressed` | `#014599` | brand (pressed) | Hyperlink text on press |
...
| Name | Token | Hex | Role | Usage |
|------|-------|-----|------|-------|
| `bg.neutral.default` | `theme.mcui.palette.background.primary` | `#FFFFFF` | neutral | Main surface, panels, headers, popovers |
...
| `bg.neutral.hovered` | `theme.mcui.palette.background.primaryHover` | `#EEEEEE` | neutral (hovered) | Surface hover state |
| `bg.neutral.pressed` | `theme.mcui.palette.background.primaryPressed` | `#E0E0E0` | neutral (pressed) | Surface pressed/active state |
| `bg.transparent` | `theme.mcui.palette.background.borderless` | `transparent` | neutral | Transparent backgrounds |
| `bg.brand.default` | `theme.mcui.palette.foundation.assent` | `#346bea` | brand | Brand/primary action backgrounds (contained buttons) |
| `bg.brand.hovered` | `theme.mcui.palette.foundation.assentHover` | `#0260C9` | brand (hovered) | Brand background hover |
| `bg.brand.pressed` | `theme.mcui.palette.foundation.assentPressed` | `#014599` | brand (pressed) | Brand background pressed |
...
| `bg.danger.bold.hovered` | `theme.mcui.palette.foundation.negativeHover` | `#c31818` | danger (hovered) | Destructive button hover |
| `bg.danger.bold.pressed` | `theme.mcui.palette.foundation.negativePressed` | `#a11010` | danger (pressed) | Destructive button pressed |
...
| `bg.neutral.fill` | `theme.mcui.palette.background.disabled` | `#F5F5F5` | neutral | Subtle grey fill for borderless elements |
...
| `bg.selected.default` | `theme.mcui.palette.background.selected` | `#E3F2FD` | selected | Selected item background |
| `bg.selected.hovered` | `theme.mcui.palette.background.selectedHover` | `#BBDEFB` | selected (hovered) | Selected item hover state |
| `bg.selected.bold` | `theme.mcui.palette.foundation.assent` | `#346bea` | selected | Bold selected background (active tab indicator) |
| `bg.input.default` | `theme.mcui.palette.background.input` | `#FFFFFF` | input | Form input backgrounds |
| `bg.input.hovered` | `theme.mcui.palette.background.inputHover` | `#FAFAFA` | input (hovered) | Form input hover |
| `bg.input.disabled` | `theme.mcui.palette.background.inputDisabled` | `#F5F5F5` | input (disabled) | Disabled form input |
...
| `border.beta` | `theme.mcui.palette.border.beta` | `#346bea` | brand | Beta feature borders |
...
| `border.input.default` | `theme.mcui.palette.border.input` | `#ececec` | input | Form input borders |
| `border.input.focused` | `theme.mcui.palette.foundation.assent` | `#346bea` | input (focused) | Form input focus state |
| `border.input.error` | `theme.mcui.palette.foundation.negative` | `#dd1f11` | input (error) | Form input error state |
...
| Name | Token | Hex | Role | Usage |
|------|-------|-----|------|-------|
| `icon.neutral.default` | `theme.mcui.palette.icon.primary` | `#8891a7` | neutral | Default icon color |
| `icon.neutral.defaultHover` | `theme.mcui.palette.icon.primaryHover` | `#52575e` | neutral (hovered) | Default icon hover state |
| `icon.neutral.subtle` | `theme.mcui.palette.icon.secondary` | `#5d5d5d` | neutral | Subdued icons, secondary actions |
| `icon.brand.default` | `theme.mcui.palette.icon.accent` | `#346bea` | brand | Brand/accent icons, active/selected state icons |
| `icon.brand.hovered` | `theme.mcui.palette.icon.accentHover` | `#0260C9` | brand (hovered) | Brand icon hover state |
| `icon.danger.default` | `theme.mcui.palette.icon.critical` | `#dd1f11` | danger | Critical/error icons |
| `icon.danger.hovered` | `theme.mcui.palette.icon.criticalHover` | `#a91b1b` | danger (hovered) | Critical icon hover state |
...
| `icon.active` | `theme.mcui.palette.icon.active` | `#346bea` | brand | DEPRECATED — use icon.brand.default |
